...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BlockListView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yanwenbo_78201@163.com/BlockListView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yanwenbo_78201@163.com' => 'yanwenbo_78201@163.com' }
  s.source           = { :git => 'https://github.com/yanwenbo_78201@163.com/BlockListView.git', :tag => s.version.to_s }
